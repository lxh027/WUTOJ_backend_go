...
func GetContestBalloon(c *gin.Context)  {
	...
	for _, submit := range submits {
		...
		value, err := database.SIsNumberOfRedisSet("balloon"+strconv.Itoa(int(contestIDJson.ContestID)), submitIdentity)
		if err != nil {
...
func SentBalloon(c *gin.Context)  {
	...
	if err := database.SAddToRedisSet("balloon"+strconv.Itoa(int(IDJson.ContestID)), submitIdentity); err != nil {
